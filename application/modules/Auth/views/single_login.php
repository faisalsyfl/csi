<html>
  <head>
    ...
    <link href="<?=base_url(); ?>css/themify-icons.css" rel="stylesheet" type="text/css"/>
    <link href="<?=base_url(); ?>css/perfect-scrollbar.css" rel="stylesheet" type="text/css"/>
  ...
  <body class="app">
      ...
      <div class="d-n@sm- peer peer-greed h-100 pos-r bgr-n bgpX-c bgpY-c bgsz-cv" style='background-image: url("images/bg.jpg")'>
        <div class="pos-a centerXY">
          <div class="bgc-white bdrs-50p pos-r" style='width: 120px; height: 120px;'>
            <img class="pos-a centerXY" src="<?=base_url(); ?>images/logo.png" alt="">
          </div>
        </div>
      </div>
    ...
    <script src="<?=base_url(); ?>js/perfect-scrollbar/perfect-scrollbar.min.js"></script>
